...
class GameOverDialog extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    // Show subtle confetti if it's a high score (above 1000)
    // final showConfetti = gameState.score >= 1000;

    return CelebrationConfettiWidget(
      showConfetti: true,
      numberOfParticles: 30, // Subtle effect
      child: Dialog(
            ...
            children: [
              ...
              SizedBox(
                ...
                child: OutlinedButton.icon(
                  ...
                  icon: Icon(Icons.bar_chart, color: Colors.blue, size: 18),
                  label: Text(
                    'View Statistics',
                    style: TextStyle(
                      color: Colors.blue,
