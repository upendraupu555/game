...
class _GameScreenState extends ConsumerState<GameScreen>
  ...
  void _checkGameOverState(GameEntity? gameState) {
    if (gameState != null && gameState.isGameOver && !_previousGameOverState) {
      // Game just ended, show the game over dialog
      WidgetsBinding.instance.addPostFrameCallback((_) {
        _showGameOverDialog(gameState);
      });
    }
    _previousGameOverState = gameState?.isGameOver ?? false;
  }
